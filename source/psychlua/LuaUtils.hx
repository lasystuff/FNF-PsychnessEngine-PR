...
class LuaUtils
{
	...
	public static function getModSetting(saveTag:String, ?modName:String = null)
	{
		...
		else
		{
			...
			MusicBeatState.instance.addTextToDebug('getModSetting: $path could not be found!', FlxColor.RED);
			#else
		...
		#if (LUA_ALLOWED || HSCRIPT_ALLOWED)
		MusicBeatState.instance.addTextToDebug('getModSetting: "$saveTag" could not be found inside $modName\'s settings!', FlxColor.RED);
		#else
