	...
	override function update(elapsed:Float)
	{
		...
		if (controls.BACK)
		{
			...
			if (PlayState.instance != null)
			{
				...
				game.playbackRate = ClientPrefs.getGameplaySetting('songspeed');
				game.healthGain = ClientPrefs.getGameplaySetting('healthgain');
				game.healthLoss = ClientPrefs.getGameplaySetting('healthloss');
				game.instakillOnMiss = ClientPrefs.getGameplaySetting('instakill');
				game.practiceMode = ClientPrefs.getGameplaySetting('practice');
				game.cpuControlled = ClientPrefs.getGameplaySetting('botplay');
